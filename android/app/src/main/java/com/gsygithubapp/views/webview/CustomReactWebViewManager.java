...
import com.gsygithubapp.views.webview.events.TopLoadingErrorEvent;
...
/**创建视图  且初始化为默认状态 所有的属性状态都通过之后的updateView来进行**/
    ...
    /**
     * ReactProp 此注解用于到处属性的设置方法
     * @param view  要修改属性的视图实例
     * @param enabled 要设置的属性值
     * 返回值类型必须为void，而且访问控制必须被声明为public
     */
